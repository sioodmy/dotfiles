        ...
        wrapFirefox firefox-esr-102-unwrapped {
          ...
          nixExtensions = [
            ...
            (pkgs.fetchFirefoxAddon {
              name = "bttv";
              url =
                "https://addons.mozilla.org/firefox/downloads/file/3984942/betterttv-7.4.35.xpi";
              sha256 = "w0db+Kwvbl15na1rScCX/QTqzoeoJHHukiS0oZTWT+M=";
            })
            (pkgs.fetchFirefoxAddon {
              name = "webarchive";
              url =
