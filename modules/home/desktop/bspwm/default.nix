...
in {
  ...
  config = mkIf cfg.enable {
    ...
    services.sxhkd.keybindings = {
      ...
      "alt + control + shift + {h,j,k,l}" = "e -z {left -30 0 || bspc node -z right -30 0, bottom 0 20 || bspc node -z top 0 30, top 0 -30 || bspc node -z bottom 0 -30, right 30 0 || bspc node -z left 30 0}";
